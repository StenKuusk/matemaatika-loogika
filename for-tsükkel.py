...
def compound_interest(amount: int, years: int, rate: int) -> float:
    ...
    """
    for compound in range(1, years+1):
        amount = amount + (amount * rate / 100)
        #print("result = " + str(amount))
    return amount
...
def remove_vowels(original_string: str) -> str:
    ...
    newstr = "".join([l for l in original_string if l not in vowels]);
    return newstr
