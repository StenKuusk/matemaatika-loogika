...
def filter_by_hobby(people_list: list, hobby: str) -> list:
    ...
    for person in people_list:
        if any([person_hobby == hobby for person_hobby in person.hobbies]):
            filtered_list.append(person)
    return sorted(filtered_list, key=lambda person: (person.hobbies, person.first_name), reverse=True)
    pass
...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
    return sorted(people_list,key=lambda person: (-len(person.hobbies), person.first_name))
    pass
...
def sort_people_and_hobbies(people_list: list) -> list:
    ...
    return sorted(people_list, key=lambda person: (person.first_name))
    pass
